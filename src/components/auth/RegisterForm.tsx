      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-dark-200/50 backdrop-blur-xl border border-primary-500/30 rounded-2xl p-8 shadow-glow-cyan">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-primary-500/20 bg-dark-300 text-primary-500 focus:ring-primary-500/50"
              />
          ...
          <div className="mt-8 pt-6 border-t border-primary-500/20">
            <p className="text-sm text-gray-400 mb-4">What you get with your free trial:</p>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-dark-200/50 text-gray-400">Or sign up with</span>
            </div>
          </div>
